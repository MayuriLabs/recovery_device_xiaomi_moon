...
void vendor_load_properties() {
    ...
    } else if (sku == "moon_p_gl") {
        model_property_override("moon", "Poco M6");
    } else if (sku == "tides_gl") {
        model_property_override("tides", "Redmi 13");
    } else if (sku == "tides_in") {
        model_property_override("tides", "Redmi 13");
    } else if (sku == "tides_p_in") {
        model_property_override("tides", "Poco M6");
    } else if (sku == "tides_t_gl"){
        model_property_override("tides", "Redmi 13");
    } else {
        model_property_override("moon", "Redmi 13");
    }
